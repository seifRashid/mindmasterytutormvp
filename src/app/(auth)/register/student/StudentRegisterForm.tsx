...
export function StudentRegisterForm({ classes, registerAction }: StudentRegisterFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} action={formAction} className="space-y-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  disabled={isPending}
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-2.5 text-xs rounded-xl bg-slate-950 border border-slate-800 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 disabled:opacity-50"
                />
                <button
                  type="button"
